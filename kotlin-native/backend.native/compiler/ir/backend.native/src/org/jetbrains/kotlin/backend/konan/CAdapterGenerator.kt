        ...
        when {
            isFunction -> {
                ...
                val bridge = if (!DescriptorUtils.isTopLevelDeclaration(function) &&
                    ...
                    generateFunction(owner.codegen, llvmDeclarations.attributeProvider.llvmFunctionType, cname) {
                    ...
                    val aliasType = pointerType(llvmDeclarations.attributeProvider.llvmFunctionType)
                    LLVMAddAlias(context.llvmModule, aliasType, llvmDeclarations.llvmFunction, cname)!!
                }
